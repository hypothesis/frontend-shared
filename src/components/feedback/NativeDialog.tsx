...
export type PanelNativeDialogProps = PresentationalProps &
  ComponentProps &
...
export type CustomNativeDialogProps = PresentationalProps &
  ComponentProps & {
...
export type NativeDialogProps =
  | PanelNativeDialogProps
  | CustomNativeDialogProps;
...
export function NativeDialog({
  ...
  const dialogRef = useSyncedRef(elementRef);
  ...
  }, [closeModal, TransitionComponent]);
  ...
  useClickAway(dialogRef, closeHandler, {
  ...
  useFocusAway(dialogRef, closeHandler, {
